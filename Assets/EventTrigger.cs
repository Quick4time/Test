...
public class TriggerSetup : EventTrigger
{
    ...
    private void AddEventTrigger(UnityAction action, EventTriggerType triggerType)
    {
        ...
        TriggerEvent trigger = new EventTrigger.TriggerEvent();
        trigger.AddListener((eventData) => action()); // ignore event data

        // Create and initialise EventTrigger.Entry using the created TriggerEvent
        Entry entry = new EventTrigger.Entry() { callback = trigger, eventID = triggerType };
